...
const messages = Messages.loadMessages('sfdx-easy-sources', 'globalvaluesets_upsert');
...
export default class Upsert extends SfCommand<unknown> {
    ...
    public async run(): Promise<unknown> {
        ...
        var result = await upsert(flags, GVSETS_SUBPATH, GVSETS_EXTENSION, GVSETS_ROOT_TAG, GVSET_ITEMS);
...
export async function globalValueSetUpsert(options: any = {}): Promise<any> {
