...
export default class Upsert extends SfdxCommand {
    ...
    protected static flagsConfig = {
        ...
        output: flags.string({
            char: 'o',
            description: messages.getMessage('outputFlagDescription', [GVSETS_DEFAULT_PATH]),
        })
    };
    ...
    public async run(): Promise<AnyJson> {
        ...
        var result = await upsert(this.flags, GVSETS_DEFAULT_PATH, GVSETS_EXTENSION, GVSETS_ROOT_TAG, GVSET_ITEMS);
