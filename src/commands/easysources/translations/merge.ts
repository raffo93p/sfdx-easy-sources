...
export default class Merge extends SfCommand<unknown> {
    ...
    public async run(): Promise<unknown> {
        ...
        var result = await merge(flags, TRANSLATIONS_SUBPATH, TRANSLATIONS_EXTENSION, TRANSLATIONS_ROOT_TAG, TRANSLATION_ITEMS);
...
export async function translationMerge(options: any = {}): Promise<any> {
