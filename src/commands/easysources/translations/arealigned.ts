...
export default class AreAligned extends SfCommand<unknown> {
    ...
    public async run(): Promise<unknown> {
        ...
        const result = await translationAreAligned(flags);
...
export async function translationAreAligned(options: any = {}): Promise<any> {
    return await areAligned(options, TRANSLATIONS_SUBPATH, TRANSLATIONS_EXTENSION, TRANSLATIONS_ROOT_TAG, TRANSLATION_ITEMS);
}
