...
export default class Upsert extends SfCommand<unknown> {
    ...
    public async run(): Promise<unknown> {
        ...
        var result = await upsert(flags, TRANSLATIONS_SUBPATH, TRANSLATIONS_EXTENSION, TRANSLATIONS_ROOT_TAG, TRANSLATION_ITEMS);
...
export async function translationUpsert(options: any = {}): Promise<any> { 
    return await upsert(options, TRANSLATIONS_SUBPATH, TRANSLATIONS_EXTENSION, TRANSLATIONS_ROOT_TAG, TRANSLATION_ITEMS);
}