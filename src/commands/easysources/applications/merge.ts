...
import { APPLICATIONS_EXTENSION, APPLICATIONS_ROOT_TAG, APPLICATIONS_SUBPATH, APPLICATION_ITEMS } from '../../../utils/constants/constants_applications.js';
...
export default class Merge extends SfCommand<unknown> {
    ...
    public async run(): Promise<unknown> {
        ...
        const result = await merge(flags, APPLICATIONS_SUBPATH, APPLICATIONS_EXTENSION, APPLICATIONS_ROOT_TAG, APPLICATION_ITEMS);
...
export async function applicationMerge(options: any = {}): Promise<any> {
    return await merge(options, APPLICATIONS_SUBPATH, APPLICATIONS_EXTENSION, APPLICATIONS_ROOT_TAG, APPLICATION_ITEMS);
}