...
export default class Split extends SfCommand<unknown> {
    ...
    public async run(): Promise<unknown> {
        ...
        const result = await split(flags, APPLICATIONS_SUBPATH, APPLICATIONS_EXTENSION, APPLICATIONS_ROOT_TAG, APPLICATION_ITEMS);
...
export async function applicationSplit(options: any = {}): Promise<any> {
