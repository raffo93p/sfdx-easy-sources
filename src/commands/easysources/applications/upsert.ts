...
import { APPLICATIONS_EXTENSION, APPLICATIONS_ROOT_TAG, APPLICATION_ITEMS, APPLICATIONS_SUBPATH } from '../../../utils/constants/constants_applications.js';
...
export default class Upsert extends SfCommand<unknown> {
    ...
    public async run(): Promise<unknown> {
        ...
        const result = await upsert(flags, APPLICATIONS_SUBPATH, APPLICATIONS_EXTENSION, APPLICATIONS_ROOT_TAG, APPLICATION_ITEMS);
...
export async function applicationUpsert(options: any = {}): Promise<any> {    
