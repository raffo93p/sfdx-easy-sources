...
import { readXmlFromFile, readCsvToJsonMap, jsonArrayCsvToMap, writeXmlToFile, calcCsvFilename, checkDirOrErrorSync, checkDirOrCreateSync } from '../../../utils/filesUtils.js'
...
import { objectTranslationSplit } from './split.js';
...
export default class Upsert extends SfCommand<unknown> {
    ...
    public async run(): Promise<unknown> {
        ...
        const result = await objectTranslationUpsert(flags);
