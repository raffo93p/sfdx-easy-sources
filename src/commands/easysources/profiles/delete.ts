...
import { PROFILES_SUBPATH, PROFILE_ITEMS } from "../../../utils/constants/constants_profiles.js";
import { deleteFromCsv } from '../../../utils/commands/deleter.js';
...
export default class Delete extends SfCommand<unknown> {
    ...
    public async run(): Promise<unknown> {
        ...
        const result = await profileDelete(flags);
