...
export default class Merge extends SfCommand<unknown> {
    ...
    public async run(): Promise<unknown> {
        ...
        var result = await merge(flags, GVSETTRANS_SUBPATH, GVSETTRANS_EXTENSION, GVSETTRANS_ROOT_TAG, GVSETTRAN_ITEMS);
...
export async function globalValueSetTranslationMerge(options: any = {}): Promise<any> {
